// -----------------------------------------------------------------------
// <copyright file="NpmRemotePackage.cs" company="Microsoft Open Technologies, Inc.">
...
// ReSharper disable once EmptyConstructor
        ...
        public bool Equals(INpmRemotePackage other)
        {
            ...
            if (!NpmPackage.IsSameStringEnumeration(Versions, other.Versions))
            {
                return false;
            }

            if (!NpmPackage.IsSameStringEnumeration(Maintainers, other.Maintainers))
            {
                return false;
            }

            if (!NpmPackage.IsSameStringEnumeration(Contributors, other.Contributors))
            {
                return false;
            }
        ...
        {
            return Equals(obj as INpmRemotePackage);
        }
