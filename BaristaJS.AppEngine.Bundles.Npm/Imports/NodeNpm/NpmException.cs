// -----------------------------------------------------------------------
// <copyright file="NpmException.cs" company="Microsoft Open Technologies, Inc.">
...
namespace BaristaJS.Appengine.Bundles.Npm.NodeNpm
{
    ...
    /// </summary>
    [Serializable]
    public class NpmException : Exception
    {
        /// <summary>
